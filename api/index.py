...
from app import create_gaussian_kernel, gaussian_blur_convolution, gaussian_blur_fourier
...
def process_image(image_path):
    ...
    face_cascade_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'haarcascade_frontalface_alt.xml')
